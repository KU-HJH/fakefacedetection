...
from sklearn.metrics import average_precision_score, precision_recall_curve, accuracy_score, precision_score, recall_score
...
def validate(model, opt):
    ...
    return acc, ap, r_acc, f_acc, y_true, y_pred, prec, recall
